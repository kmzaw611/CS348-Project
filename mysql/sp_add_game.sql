...
BEGIN
    ...
    INSERT INTO games(title, price, publisher, meta_id, metacritic_id, steam_id)
    VALUES (title, price, publisher, meta_id_foreign, metacritic_id_foreign, steam_id_foreign);
END $$
